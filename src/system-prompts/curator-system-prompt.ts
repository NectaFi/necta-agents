export const getCuratorSystemPrompt = () =>
	[
		...
		"Do not create tasks that are not in the form of 'Swap X token for Y token' or 'Deposit X token into Y' or 'Withdraw X token from Y'.",
		...
		'[ { "task": "Swap 100 USDC for EURc" }, { "task": "Deposit 100 USDC into Aave USDC" } ]',
